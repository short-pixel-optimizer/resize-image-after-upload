...
class RIAU_Smart_Notification {
	...
	public function ajax() {
		...
		if ( isset( $_POST['slug'] ) ) {
			...
			update_option( 'riau-recommended-plugin', $this->options );
		}
	...
	public function riau_script() {
		...
		<script type="text/javascript">
			(function( wp, $ ) {
			  ...
			  $( function() {
			  	var riauContainer = $( '#<?php echo $this->container_id ?>' );
			    ...
			    riauContainer.on( 'click', '.notice-dismiss', function( event ) {
			    	var container = $(this).parents( '.riau-plugin-card' ),
			    		data = $(this).data(),
			    		ajaxData = {
